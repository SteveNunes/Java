...
public class Jogo {
  ...
  /**
   *
   * Gera uma nova palavra, baseada no nivel informado. Ao gerar a nova palavra, a string 'oculta' é redifinida com asteriscos na quantidade de letras da palavra atual, e a string
   * 'letrasJaUtilizadas' é limpa.
   */
  ...
  public int getTamanhoDaPalavraAtual() {
   ...
   */
  public boolean palavraFoiRevelada() {
    return palavraOculta.indexOf('*')==-1?true:false;
  }
  ...
  /**
   *
   * Verifica se a letra informada esta presente na palavra atual. Se estiver, atualiza a string 'palavraOculta' revelando a letra nas posicoes correspondentes. Retorna o total de vezes que a letra
   * foi encontrada na palavra atual.
   */
