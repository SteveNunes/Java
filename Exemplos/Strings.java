...
public class Strings {
  public static void main(String args[]) {
    /**
     * Diferente de C++, no Java você tem a disponibilidade de uso de Strings sem a necessidade de bibliotecas externas.
     */
    ...
    for (n=1; palavra.hasMoreTokens(); n++) System.out.println("Token "+n+": "+palavra.nextToken());
