class ClassesEHerancas {
	...
	public static void main(String args[]) {
		...
		for(Classes classe : Classes.values()) 
			util.imprimirTexto(classe.getValor() + " - " + classe.name() + "\n");
...
enum Classes {
    ...
    Classes(int valor) { this.valor = valor; }
...
class Barbaro extends Personagem {
	private int forca;
	Barbaro(String nome) { 
		super(nome, "Barbaro", 1000, 100); forca = 100; 
		dadosDoPersonagem(); 
	}
	protected void dadosDoPersonagem() {
...
class Mago extends Personagem {
	private int magica;
	Mago(String nome) { 
		super(nome, "Mago", 300, 1500); magica = 100; 
		dadosDoPersonagem(); 
	}
	protected void dadosDoPersonagem() {
		super.dadosDoPersonagem();
...
class Arqueiro extends Personagem {
	...
	Arqueiro(String nome) { 
		super(nome, "Arqueiro", 550, 300); dextreza = 100; 
		dadosDoPersonagem(); 
	}
	protected void dadosDoPersonagem() {
		super.dadosDoPersonagem();
...
class Rouge extends Personagem {
	private int sorte;
	Rouge(String nome) { 
		super(nome, "Rouge", 400, 500); sorte = 100; 
		dadosDoPersonagem(); 
	}
	protected void dadosDoPersonagem() {
		super.dadosDoPersonagem();
