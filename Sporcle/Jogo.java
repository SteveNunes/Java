...
public class Jogo {
	...
	public int getPalavrasDescobertas() { return palavrasDescobertas; }
	
	public int getTotalDeErros() { return totalDeErros; }
	
	public void setTotalDeErros(int erros) { totalDeErros = erros; }

	public void incrementaTotalDeErros() { totalDeErros++; }

	public void resetarJogo() { nivelAtual = 1; totalDeErros = 0; }
	
	public void resetarPalavrasDescobertas() 
		{ palavrasDescobertas = 0; for(int n = 0; n < 200; n++) palavrasJaUtilizadas[n] = ""; }
	
	public boolean palavraJaUtilizada(String palavra) {
		for (String i : palavrasJaUtilizadas) 
			if (i.toLowerCase().equals(palavra.toLowerCase())) return true;
		return false;
	}
